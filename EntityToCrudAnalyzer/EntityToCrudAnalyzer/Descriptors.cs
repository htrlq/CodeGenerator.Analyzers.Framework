...
namespace EntityToCrudAnalyzer
{
    ...
    {
        public static DiagnosticDescriptor ConfigDescriptor { get; }
           = Create("P1001", "Project", "未找到配置文件 Config.xmls");

        public static DiagnosticDescriptor ConfigFailDescriptor { get; }
            = Create("P1001", "Project", "配置文件内容错误:{0}");
